...
--     PRIMARY KEY (`id`),
--     UNIQUE KEY (`code`)
-- ) ENGINE = InnoDB COMMENT 'Quản lý nhà cung cấp thiết bị'
--   DEFAULT CHARSET = utf8mb4
--   COLLATE = utf8mb4_0900_ai_ci;
...
(
    ...
    `type`              int          NOT NULL COMMENT '0 - ADMIN, 1 - PROVIDER_DEVICE, 2 -PROVIDER_CONTENT, 3- PARTNER_LICENSE, 4- MERCHANT',
...
VALUES (1, 'Tổng quan', 'DASHBOARD', 'STATISTIC', true, null, null, null, 0, 1, now(), now()),
       (2, 'Tài khoản', 'ACCOUNT', 'CONFIG', true, true, true, true, 0, 1, now(), now()),
       (3, 'Phân quyền', 'ROLE', 'CONFIG', true, true, true, true, 0, 1, now(), now()),

       (4, 'Tổng quan', 'DASHBOARD', 'STATISTIC', true, null, null, null, 1, 1, now(), now()),
       (5, 'Tài khoản', 'ACCOUNT', 'CONFIG', true, true, true, true, 1, 1, now(), now()),
       (6, 'Phân quyền', 'ROLE', 'CONFIG', true, true, true, true, 1, 1, now(), now()),

       (7, 'Tổng quan', 'DASHBOARD', 'STATISTIC', true, null, null, null, 2, 1, now(), now()),
       (8, 'Tài khoản', 'ACCOUNT', 'CONFIG', true, true, true, true, 2, 1, now(), now()),
       (9, 'Phân quyền', 'ROLE', 'CONFIG', true, true, true, true, 2, 1, now(), now()),

       (10, 'Tổng quan', 'DASHBOARD', 'STATISTIC', true, null, null, null, 3, 1, now(), now()),
       (11, 'Tài khoản', 'ACCOUNT', 'CONFIG', true, true, true, true, 3, 1, now(), now()),
       (12, 'Phân quyền', 'ROLE', 'CONFIG', true, true, true, true, 3, 1, now(), now()),

       (13, 'Tổng quan', 'DASHBOARD', 'STATISTIC', true, null, null, null, 4, 1, now(), now()),
       (14, 'Tài khoản', 'ACCOUNT', 'CONFIG', true, true, true, true, 4, 1, now(), now()),
       (15, 'Phân quyền', 'ROLE', 'CONFIG', true, true, true, true, 4, 1, now(), now());
...
VALUES (1, 'ABCDEFGH', 'Admin', '0365517544', 'admin@gmail.com',
        '$2a$10$ilkXcSZX49ghvrsdb2UEi.X1nNjhRPfl2Qvp2h5l3jgXAFC0gYCdS', 1, 1,
        now(), now());
